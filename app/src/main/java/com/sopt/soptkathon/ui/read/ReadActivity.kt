    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            ivReadStar1.setOnClickListener {
                ...
                customDialog.showDialog(R.layout.dialog_letter, viewModel.letterList.value[0].content, viewModel.letterList.value[0].sender)
            }
            ivReadStar2.setOnClickListener {
                val customDialog = CustomDialog(this@ReadActivity)
                customDialog.showDialog(R.layout.dialog_letter, viewModel.letterList.value[1].content, viewModel.letterList.value[1].sender)
            }
            ivReadStar3.setOnClickListener {
                val customDialog = CustomDialog(this@ReadActivity)
                customDialog.showDialog(R.layout.dialog_letter, viewModel.letterList.value[2].content, viewModel.letterList.value[2].sender)
            }
            ivReadStar4.setOnClickListener {
                val customDialog = CustomDialog(this@ReadActivity)
                customDialog.showDialog(R.layout.dialog_letter, viewModel.letterList.value[3].content, viewModel.letterList.value[3].sender)
            }
        }
